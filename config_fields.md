...
## Что класть в отдельный репозиторий
Для нового репозитория достаточно двух файлов:

1. `config.json` — сам конфиг с параметрами
2. `config_fields.md` — описание полей и назначения
